  ...
  return (
    <div className="ecl-fade-up mt-10 rounded-2xl p-6 sm:p-8" style={{ animationDelay: '160ms', background: COLOR.bg, border: `1px solid ${COLOR.border}` }}>
      ...
      >
        ...
        <span
          className="ecl-breathe absolute -right-2 -top-2 flex items-center gap-1 rounded-full px-3 py-1.5 text-[11px] font-medium text-white shadow-md"
          style={{ backgroundImage: `linear-gradient(45deg, ${COLOR.primary} 0%, ${COLOR.secondary} 50%, ${COLOR.accent} 100%)` }}
        >
    ...
    <div className="ecl-fade-up mt-10 rounded-2xl p-6 sm:p-8" style={{ animationDelay: '200ms', background: COLOR.bg, border: `1px solid ${COLOR.border}` }}>
      ...
      >
        <div
          ...
          style={{ borderRadius: '1.05rem', background: `linear-gradient(160deg, ${COLOR.primary} 0%, ${COLOR.secondary} 100%)` }}
        >
        ...
        <span
          className="ecl-breathe absolute -right-2 -top-2 flex items-center gap-1 rounded-full px-3 py-1.5 text-[11px] font-medium text-white shadow-md"
          style={{ backgroundImage: 'linear-gradient(45deg, #f9ce34 0%, #ee2a7b 45%, #6228d7 100%)' }}
        >
...
function ReferWizard({ onExit, onSubmitReferral }) {
  ...
  const [patient, setPatient] = useState({ firstName: 'John', lastName: 'Smith', dob: '1986-03-14', email: '', phone: '020 7946 0958', contactMethod: 'either', consent: true });
